  ...
  return (
    <>
      <div className="bg-black bg-opacity-70 w-full h-full fixed z-50 inset-0 flex items-center justify-center edit-overlay">
        <div className="relative h-[400px] w-[37.5rem] my-[24px] mx-auto flex-col rounded-[8px] bg-white">
          <svg
            stroke="currentColor"
            fill="currentColor"
            strokeWidth="0"
          ...
          <div className="document_modal">
            <div className="flex justify-between w-full">
              {formData.documentType === 'workcertificate' ||
              formData.documentType === 'othercertificate' ? (
                <div className="w-[30%]">
                  <label
                    htmlFor=""
            ...
            <div className="float-right ml-[0.75rem] mt-[1.5rem]">
              <button
                ...
                cursor-pointer text-white bg-red-500 mb-[20px] border-none mt-[10px]"
