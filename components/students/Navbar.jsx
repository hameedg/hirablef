        ...
        <div className=" pl-16 lg:flex space-x-4 items-center w-full justify-between hidden">
          <div className="lg:flex space-x-8 items-center justify-start">
            ...
            <Link
              href="/students"
              passHref
              className="block text-sm hover:text-[#0dbd8b] text-black cursor-pointer leading-[1.6em] ">
        ...
        <div className="ml-auto lg:hidden">
          ...
          >
            ...
            <div className="flex flex-col items-start justify-start space-y-8 mt-8 mb-8">
              <Link href="/colleges" passHref className="px-3">
                Colleges
              </Link>
              <Link
                href="/students"
              ...
              <Link href="/companies" passHref className="px-3">
                Companies
              </Link>
            </div>
