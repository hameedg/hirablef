...
const JoinWaitlist = () => (
  <div className=" mt-4 w-[60.313rem] rounded-2xl mx-auto cursor-default">
    <nav className="flex justify-center items-center  mt-4 gap-4 rounded-2xl">
      <div className="h-[220px] flex flex-col w-[48%] border border-[#ebedf1] bg-white rounded-2xl">
      ...
      <img
        ...
        className="object-fill w-[60%] h-[220px] border border-[#ebedf1] bg-white rounded-2xl"
        alt=""
      />
    </nav>
  </div>
